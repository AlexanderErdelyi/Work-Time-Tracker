...
namespace Timekeeper.Core.Data.Migrations
{
    ...
    [Migration("20260225071738_AddWorkspaceSupportIssueToken")]
    partial class AddWorkspaceSupportIssueToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Timekeeper.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 2, 25, 7, 17, 38, 383, DateTimeKind.Utc).AddTicks(3722),
